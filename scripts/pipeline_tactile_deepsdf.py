...
if __name__=='__main__':
    ...
    # )
    # parser.add_argument(
    #     "--dataset", default='ShapeNetCore', type=str, help="Dataset used: 'ShapeNetCore', 'ShapeNetCore_test', 'ABC_train', or 'ABC_test'"
    # )
    # parser.add_argument(
    ...
    train_cfg_path = os.path.join(os.path.dirname(config_files.__file__), 'pipeline_tactile_deepsdf.yaml')
